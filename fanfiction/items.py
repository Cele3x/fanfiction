...
class Story(Item):
    ...
    storyCreatedAt = Field(input_processor=DEFAULT_INPUT_PROCESSORS, output_processor=TakeFirst())
    storyUpdatedAt = Field(input_processor=DEFAULT_INPUT_PROCESSORS, output_processor=TakeFirst())
